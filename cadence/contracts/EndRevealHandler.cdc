...
access(all) contract EndRevealHandler {
    ...
    access(all) resource Handler: FlowTransactionScheduler.TransactionHandler {
        ...
        access(FlowTransactionScheduler.Execute) fun executeTransaction(id: UInt64, data: AnyStruct?) {
            ...
            // Process the round (end reveal phase)
            game.processRound()
            
            log("Transaction executed - End reveal phase and process round for game ".concat(self.gameId.toString()))
        }
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                case Type<StoragePath>():
                    return /storage/EndRevealHandler
                case Type<PublicPath>():
                    return /public/EndRevealHandler
                default:
                    return nil
            }
        }
